...
class SimpleDialog:
    ...
    def __init__(self, master,
        ...
        self.message = ttk.Label(self.root, text=text, wraplength=400)
        self.message.pack(expand=1, fill=BOTH, padx=10, pady=10)
        ...
        for num in range(len(buttons)):
            ...
            if num == default:
                b.config(style="Default.TButton")
            b.pack(side=LEFT, fill=BOTH, expand=1, padx=5)
...
class Dialog(Toplevel):
    ...
    def buttonbox(self):
        ...
        w = ttk.Button(box, text="OK", width=10, command=self.ok, style="TButton")
        w.pack(side=LEFT, padx=5, pady=5)
        w = ttk.Button(box, text="Cancel", width=10, command=self.cancel, style="TButton")
        w.pack(side=LEFT, padx=5, pady=5)
...
class _QueryDialog(Dialog):
    ...
    def body(self, master):
        ...
        w.grid(row=0, padx=5, pady=5, sticky=W)
...
def askinteger(title, prompt, **kw):
    ...
    Keyword arguments:
        ...
        minvalue, maxvalue --
            Minimum and maximum values for the dialog.
            Default is None.
